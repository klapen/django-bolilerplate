...
Contains settings in common for development, QA and production environment.

Adapted from 'django-admin startproject' using Django 3.0.2.
...
#          add a new file
# EXAMPLE: Uncomment if you are going to use REST Framework
